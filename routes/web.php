...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'role:supperadmin,admin']],function(){
	...
	Route::group(['prefix' => 'bu'], function(){
		...
		Route::get('delete-produce/{id}', 'BuController@getDeleteProduce')->name('delete.produce');
		Route::post('add-variable/{id}', 'BuController@postAddvariable');
		Route::get('delete-variable/{id}', 'BuController@getDeletevariable')->name('delete.variable');
		Route::post('add-fixed/{id}', 'BuController@postAddFixed');
		Route::get('delete-fixed/{id}', 'BuController@getDeleteFixed')->name('delete.fixed');
