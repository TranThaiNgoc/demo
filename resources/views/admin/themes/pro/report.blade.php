...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#prolinelist">Proline List</a></li>
...
<div class="tab-content">
    <div class="row tab-pane fade in active" id="prolinelist">
        <div class="white-box">
            <div class="row">
                <div class="col-md-2">
    ...
    <div class="row tab-pane fade" id="chart">
        1/ Bieu do cot, the hien chi phi doanh thu va loi nhuan cua produce.
        <br>
